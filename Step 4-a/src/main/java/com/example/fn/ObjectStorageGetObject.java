...
//                    .build();
//            System.out.println("Getting content for object " + objectInfo.getName() + " from bucket " + objectInfo.getBucketName());
//
...
//
//            System.out.println("Finished reading content for object " + objectInfo.getName());
